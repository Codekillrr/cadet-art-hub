...
export default function Home() {
  ...
  return (
    <div className="absolute w-full h-full overflow-x-hidden overflow-auto">
      ...
      <div className="pt-[5rem] relative overflow-hidden [font-family:var(--tech)] font-bold">
        {/* <video
          className="absolute   w-full h-full object-cover  z-[-1] pointer-events-none opacity-50 mix-blend-screen" //object-contain top-[-20%] left-10 scale-420 min-[380px]:scale-300 min-[425px]:scale-270 overflow-hidden object-[37%_center]
          autoPlay
          loop
          muted
          playsInline
        ...
        <div className="mt-8 mb-30 z-100 flex justify-evenly mx-4">
        ...
        {/* <div className="absolute z-10 w-full inset-x-0 bottom-0 h-10 bg-gradient-to-b from-transparent via-black/80 to-black scale-[1.1] pointer-events-none"></div> */}
      </div>

      <div className="relative">
        <div className="absolute flex items-end z-10 w-full inset-x-0 -top-30 h-70 bg-transparent scale-[1.1] pointer-events-none">
          <div className="absolute bg-black blur-xl w-full h-20 top-18 -z-10"></div>
          <SlideShow />
        </div>

        <div className="mx-4 pt-60 relative z-20 py-10 md:py-40 [font-family:var(--tech)]">
          <Services />
        </div>

        <div className="mt-10 grid grid-cols-1 gap-2 px-6 [font-family:var(--tech)]">
        ...
        <div className="relative z-20 pt-0 pb-20 [font-family:var(--tech)]">
          ...
          <h2 className="text-sm md:text-base my-4 text-muted text-neutral-400 font-normal dark:text-muted-dark px-10 text-center max-w-lg mx-auto">
            <span className="inline-block items-center text-wrap">
              Cadet Artistry Hub is used by companies of every size. Here's what
        ...
        <div className="relative">
          <section className="pb-10 w-full  overflow-hidden relative z-30 [font-family:var(--tech)]">
            <div className="mx-auto w-full relative z-20 sm:max-w-[40rem]  md:max-w-[48rem] lg:max-w-[64rem] xl:max-w-[80rem] bg-gradient-to-br from-neutral-900 to-neutral-950 sm:rounded-2xl">
              <div className="relative -mx-6   sm:mx-0 sm:rounded-2xl overflow-hidden px-6  md:px-8 ">
                ...
                <div className="relative px-6 pb-14 pt-20 sm:px-10 sm:pb-20 lg:px-[4.5rem]">
                  ...
                  <p className="mt-4 max-w-[26rem] text-center mx-auto text-base/6 text-neutral-200">
                    Join the next generation of designers and artists. <br />{" "}
                    Get started with the Cadets's plan today.
                  </p>
